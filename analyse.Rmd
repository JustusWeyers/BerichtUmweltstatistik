...
ggplot(data |> drop_na(linModel), aes(x = Bodenfeuchte_Prozent, y = linModel))+
  ...
  labs(title = "Abweichung von vorhergesagten und gemessenen Werten", subtitle = "Einfaches lineares Modell" ,x = "Messwerte", y = "Vorhersage", caption = "Bodenfeuchte [%]", colour = "Stratum")+
